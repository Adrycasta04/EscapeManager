...
Il calcolo del prezzo della prenotazione (UC1) è demandato alla \texttt{PricingStrategy}. Il Controller, in base alla data della prenotazione, inietta la strategia corretta all'interno dell'entità.
