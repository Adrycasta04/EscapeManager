...
Il livello di persistenza segue il pattern \textbf{Abstract Factory} (DAO Factory) per disaccoppiare completamente i Controller dall'infrastruttura di database. La Figura \ref{fig:class_diagram_dao} mostra l'organizzazione delle classi nel package \texttt{dao}, evidenziando la gerarchia delle interfacce, le implementazioni concrete per PostgreSQL e il \texttt{ConnectionManager} Singleton.
