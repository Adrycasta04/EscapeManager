...
Per illustrare le dinamiche di interazione a \textit{run-time} tra gli oggetti, si fa riferimento all'approccio descritto nello standard UML per la \textit{Implementation Perspective}. Di seguito vengono presentati due Sequence Diagram per i casi d'uso più rappresentativi.
