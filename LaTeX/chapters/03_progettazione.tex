...
\begin{itemize}
    ...
    \item \textbf{UTENTE}(\underline{id}, email, password\_hash, ruolo, nome*, telefono*, matricola*, livello\_accesso*) \\
    \textit{* = attributo nullable a seconda del ruolo}
